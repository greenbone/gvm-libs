...
typedef enum
{
  ...
  AD_CONNECTOR_OPT_NETWORK_TIMEOUT,    /**< Network timeout (seconds),
                                            0 for no explicit timeout/default LDAP behavior*/
...
typedef enum
{
  ...
  AD_SEARCH_CONFIG_OPT_SCOPE,             /**< Search scope. Instance of ad_connector_search_scope_t */
  ...
  AD_SEARCH_CONFIG_OPT_OBJECT_TYPES,      /**< Object types to search for. Bitmask of ad_object_type_t */
  AD_SEARCH_CONFIG_OPT_EXTRA_ATTRIBUTES,  /**< Extra attributes to retrieve from the LDAP entries */
  AD_SEARCH_CONFIG_OPT_INCLUDE_DISABLED_COMPUTERS,  /**< Whether to include disabled computer
...
ad_connector_return_t
ad_search_config_builder (ad_search_config_t,
                          ad_search_config_opt_t,
                          const void *);

void
ad_search_config_free (ad_search_config_t);

ad_connector_t
ad_connector_new (void);

ad_connector_return_t
ad_connector_builder (ad_connector_t,
                      ad_connector_opt_t,
                      const void *);

void
ad_connector_free (ad_connector_t);

ad_connector_return_t
ad_connector_connect (ad_connector_t, const gchar *);

ad_connector_return_t
ad_connector_search_objects (ad_connector_t,
                             const ad_search_config_t,
