...
static init_func libfuncs[] = {
  ...
  { "ntlmv2_response", nasl_ntlmv2_response, 0, { "address_list", "address_list_len", "crypt_key", "domain", "ntlmv2_hash", "user", NULL } },
  { "ntlm2_response", nasl_ntlm2_response, 0, { "cryptkey", "nt_hash", "password", NULL } },
  { "ntlm_response", nasl_ntlm_response, 0, { "cryptkey", "neg_flags", "nt_hash", "password", NULL } },
  { "key_exchange", nasl_keyexchg, 0, { "cryptkey", "nt_hash", "session_key", NULL } },
  ...
  { "get_signature", nasl_get_sign, 0, {"buf", "buflen", "key", "seq_number", NULL } },
  ...
  { "wmi_reg_enum_key", nasl_wmi_reg_enum_key, 0, { "hive", "key", "wmi_handle", NULL } },
  { "wmi_reg_enum_value", nasl_wmi_reg_enum_value, 0, { "hive", "key", "wmi_handle", NULL } },
  { "wmi_reg_get_sz", nasl_wmi_reg_get_sz, 0, { "hive", "key", "key_name", "wmi_handle", NULL } },
  { "wmi_reg_get_bin_val", nasl_wmi_reg_get_bin_val, 0, { "hive", "key", "val_name", "wmi_handle", NULL } },
  { "wmi_reg_get_dword_val", nasl_wmi_reg_get_dword_val, 0, { "hive", "key", "val_name", "wmi_handle", NULL } },
  { "wmi_reg_get_ex_string_val", nasl_wmi_reg_get_ex_string_val, 0, { "hive", "key", "val_name", "wmi_handle", NULL } },
  { "wmi_reg_get_mul_string_val", nasl_wmi_reg_get_mul_string_val, 0, { "hive", "key", "val_name", "wmi_handle", NULL } },
  { "wmi_reg_get_qword_val", nasl_wmi_reg_get_qword_val, 0, { "hive", "key", "val_name", "wmi_handle", NULL } },
