...
cyberark_error_t
cyberark_connector_builder (cyberark_connector_t, cyberark_connector_opts_t,
                            const void *);

void cyberark_connector_free (cyberark_connector_t);

int
cyberark_verify_connection (cyberark_connector_t, const gchar *, const gchar *,
                            const gchar *);

cyberark_object_t
cyberark_get_object (cyberark_connector_t, const gchar *, const gchar *,
                     const gchar *);
