/* OpenVAS
* $Id$
* Description: Banner comparison functions.
*
...
*/ 
 ...
 /* 
 * The problem with banner comparison is that a lot of banners display 
 * the current time of the day along their lines.
