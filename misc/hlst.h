...
extern hlst *create_hlst (unsigned estimated_size_hint,
                          /* this function is called when non-empty slots are removed, if the
                             ...
                             non NULL item, */
                          void (*destroy) (void *state, void *item, char *key,
                                           unsigned keylen), void *state);

extern hlst *copy_hlst (hlst * to_be_copied,
                        ...
                        /* The copy() function is called when an entry is to be copied and
                           ...
                           function. */
                        void *(*copy) (void *cpstate, void *item, char *key,
                                       unsigned keylen), void *cpstate,
...
extern int for_hlst_do (hlst *,
                        ...
                        int (*fn) (void *state, void *, char *key,
                                   unsigned keylen), void *state);
...
/* custom sort */
extern int csort_hlst (hlst *,
                       /* custom comparison function for qsort */
                       int (*)(void *desc, const char *left_key,
                               unsigned left_klen, const char *right_key,
                               unsigned right_klen), void *desc);
